            ...
            <tbody>
              {scores.map((c: any, i: number) => (
                <tr key={i} className="border-b border-border/30">
                  ...
                  <td className="py-2 text-center font-mono">{c?.review_volume_ratio ?? 0}x</td>
                  <td className="py-2 text-center font-mono">{c?.authority_score ?? 0}/10</td>
                  <td className="py-2 text-center font-mono">{c?.media_mentions_score ?? 0}/10</td>
                  <td className="py-2 text-center font-mono">{c?.clinical_authority_score ?? 0}/10</td>
